...
import uvicorn
from logging_config import configure_logging, configure_azure_monitor
...
def create_app() -> FastAPI:
    ...
    # Configure Azure Monitor for distributed tracing (Application Map)
   ...
   # Add mcp server to the FastAPI app
    ...
    app = FastAPI(title="Transaction API and MCP server",
...
if __name__ == "__main__":
    ...
    logger.info(
        f"Starting transaction service server with profile: {profile}, port: {port}")
